...
#! COPIA DE CLASE PAIS RESOLVIENDO AG CON ELITISMO. ANTES DE SEPARAR LA CLASE AG PARA IMPLEMENTAR SIN ELITISMO
class pais:
    ciudades = []
    ...
    def generarMapa(self, secuencia_viaje, opcionMenu):
        ...
        if opcionMenu == 1:
            ...
            m.save(f'mapa_3{secuencia_viaje[0]}.html')
    
    def generarGrafico(self, serie, tipo_grafica):
        ...
        if tipo_grafica == "fitness":
            ...
            plt.savefig('converg_genet_fitness.png')
        if tipo_grafica == "fitness":
            plt.savefig('converg_genet_distancias.png')
        elif tipo_grafica == "distancias":
